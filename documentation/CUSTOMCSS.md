...
## Extended Example
The extended example below modifies the AynReader interface to be more minimal and illustrates a variety of uses of the AynReader class names and CSS.  There are examples of styling AynReader classes directly as well as examples of more complicated selection rules.
...
## AynReader Useful Elements
The table below shows some elements of the AynReader main page that are useful for applying custom CSS.  Note that these are elements, not class names, so you must use these without the leading period used to reference a class name.  For example:
...
## AynReader Class Names
The table below shows the AynReader specific class names.  To reference a class name in a CSS rule, use a leading period.  For example:
...
|--------------------------|--------------------------------------------------------------------------------|
| cf-logo-title            | The AynReader logo and title in upper left of page                             |
| cf-logo                  | The AynReader logo                                                             |
| cf-title                 | The AynReader title                                                            |
