...
public interface AynReaderConfiguration {
     ...
     *
     * <p>This is useful if aynreader is accessed through a restricting proxy that blocks some feeds
     * that are followed.
     */
    @WithDefault("false")
    ...
    interface HttpClient {
         ...
         *
         * <p>You may want to enable this if you host a public instance of AynReader with
         * registrations open.
         */
        @WithDefault("false")
    ...
    interface FeedRefresh {
        /** Default amount of time AynReader will wait before refreshing a feed. */
        @WithDefault("5m")
        Duration interval();

        /**
         * Maximum amount of time AynReader will wait before refreshing a feed. This is used as an
         * upper bound when:
         *
         * <ul>
        ...
        /**
         * If enabled, AynReader will calculate the next refresh time based on the feed's average
         * time between entries and the time since the last entry was published. The interval will
         * be sometimes between the default refresh interval (`aynreader.feed-refresh.interval`) and
         * the maximum refresh interval (`aynreader.feed-refresh.max-interval`).
         *
