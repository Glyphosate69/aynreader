...
import com.aynreader.backend.feed.FeedEntryKeyword.Mode;
...
import com.aynreader.backend.model.QFeed;
import com.aynreader.backend.model.QFeedEntry;
import com.aynreader.backend.model.QFeedEntryContent;
import com.aynreader.backend.model.QFeedEntryStatus;
import com.aynreader.backend.model.QFeedEntryTag;
import com.aynreader.backend.model.QFeedSubscription;
...
public class FeedEntryStatusDAO extends GenericDAO<FeedEntryStatus> {
    ...
    private void fetchTags(User user, List<FeedEntryStatus> statuses) {
        Map<Long, List<FeedEntryTag>> tagsByEntryIds =
    ...
    public long autoMarkAsRead(int limit) {
        ...
        NumberExpression<Integer> daysDiff =
