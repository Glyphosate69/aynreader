...
import com.aynreader.AynReaderConfiguration.HttpClientCache;
...
public class HttpGetter {
    ...
    private HttpResponse invoke(HttpRequest request) throws IOException {
        ...
        context.setRequestConfig(
                RequestConfig.custom()
                        ...
                        // Keep the response body available when the server sends no content type.
    ...
    private static Cache<HttpRequest, HttpResponse> newCache(AynReaderConfiguration config) {
