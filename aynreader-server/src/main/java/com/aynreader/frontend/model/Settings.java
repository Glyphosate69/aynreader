...
import com.aynreader.backend.model.UserSettings.PushNotificationType;
...
public class Settings implements Serializable {
    ...
    @Schema(description = "show Ayn Reader OS's own context menu on right click", required = true)
