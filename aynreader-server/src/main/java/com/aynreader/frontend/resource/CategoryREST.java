...
import com.aynreader.frontend.model.Category;
...
import com.aynreader.frontend.model.request.AddCategoryRequest;
import com.aynreader.frontend.model.request.CategoryModificationRequest;
import com.aynreader.frontend.model.request.CollapseRequest;
...
public class CategoryREST {
    ...
    private static final Comparator<Category> CATEGORY_COMPARATOR =
            Comparator.comparing(Category::getPosition).thenComparing(Category::getName);
    private static final Comparator<Subscription> SUBSCRIPTION_COMPARATOR =
            Comparator.comparing(Subscription::getPosition).thenComparing(Subscription::getName);
    ...
    public Response getCategoryEntries(
            @Parameter(description = "id of the category, 'all' or 'starred'", required = true)
                    @QueryParam("id")
                    String id,
    ...
    public Response markCategoryEntries(
            @Valid @Parameter(description = "category id, or 'all'", required = true)
                    MarkRequest req) {
        ...
        if (ALL.equals(req.getId())) {
            ...
            feedEntryService.markSubscriptionEntries(
                    user, subs, olderThan, insertedBefore, entryKeywords);
