...
class PushNotificationServiceTest {
    ...
    void init(MockServerClient mockServerClient) {
        ...
        this.config = Mockito.mock(AynReaderConfiguration.class, Mockito.RETURNS_DEEP_STUBS);
        ...
        HttpClientFactory httpClientFactory =
                new HttpClientFactory(config, Mockito.mock(com.aynreader.AynReaderVersion.class));
