...
class DatabaseCleaningServiceTest {
    ...
    @Mock private AynReaderConfiguration config;

    @Mock private AynReaderConfiguration.Database databaseConfig;

    @Mock private AynReaderConfiguration.Database.Cleanup cleaningConfig;
