...
class FeedEntryFilteringServiceTest {
    ...
    @BeforeEach
    void init() {
        config = Mockito.mock(AynReaderConfiguration.class, Mockito.RETURNS_DEEP_STUBS);
        ...
        entry = new FeedEntry();
        entry.setUrl("https://github.com/AynReader/aynreader");
    ...
    void endsWithExpression() throws FeedEntryFilterException {
        Assertions.assertTrue(service.filterMatchesEntry("url.endsWith(\"aynreader\")", entry));
    }
