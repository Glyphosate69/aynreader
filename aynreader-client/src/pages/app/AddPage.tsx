...
import { TbFileImport, TbFolderPlus, TbRss, TbWorldSearch } from "react-icons/tb"
import { AddCategory } from "@/components/content/add/AddCategory"
import { ImportOpml } from "@/components/content/add/ImportOpml"
import { Scrap } from "@/components/content/add/Scrap"
        ...
        <Container size="sm" px={0}>
            <Tabs defaultValue="subscribe">
                <Tabs.List>
                    ...
                    <Tabs.Tab value="scrap" leftSection={<TbWorldSearch size={16} />}>
                        Scrap
                    </Tabs.Tab>
                </Tabs.List>
