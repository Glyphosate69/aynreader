    ...
    return (
        <Box>
            ...
            <Anchor href={href} target="_blank" rel="noreferrer">
                <Trans>Ayn Reader OS next unread item</Trans>
            </Anchor>
        </Box>
    )
}
        ...
        <Container size="xl">
            <SimpleGrid cols={{ base: 1, [Constants.layout.mobileBreakpointName]: 2 }}>
                <Section title={<Trans>About</Trans>} icon={<TbHelp size={24} />}>
                    <Box>
                        <Trans>
                            Ayn Reader OS version {version} ({revision}).
                        </Trans>
                    </Box>
                    {isBrowserExtensionInstallable && isBrowserExtensionInstalled && (
                        <Box>
                            <Trans>Ayn Reader OS browser extension version {browserExtensionVersion}.</Trans>
                        </Box>
                    )}
                    <Box mt="md">
                        <Trans>
                            Ayn Reader OS est une plateforme de lecture et de veille RSS conçue pour organiser l'information sans bruit.
                        </Trans>
                    </Box>
                    <Box>
