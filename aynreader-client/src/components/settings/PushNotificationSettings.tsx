...
export function PushNotificationSettings() {
    ...
    if (!pushNotificationsEnabled) {
        return <Trans>Push notifications are not enabled on this Ayn Reader OS instance.</Trans>
    }
    return (
            ...
            <Stack>
                ...
                {form.values.type === "ntfy" && (
                    <>
                        ...
                        />
                        <TextInput label={<Trans>Topic</Trans>} placeholder="aynreader" required {...form.getInputProps("topic")} />
