...
import { redirectToAbout, redirectToAdminUsers, redirectToMetrics, redirectToNewsletter, redirectToSettings } from "@/app/redirect/thunks"
    ...
    return (
        <Menu position="bottom-end" closeOnItemClick={false} opened={opened} onChange={setOpened}>
            ...
            <Menu.Dropdown>
                ...
                <Menu.Item
                    leftSection={<TbMail size={iconSize} />}
                    onClick={() => {
                        dispatch(redirectToNewsletter())
                        setOpened(false)
                    }}
                >
                    Newsletter
