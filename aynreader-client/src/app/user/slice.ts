...
import type { LocalSettings, NewsletterSettings, Settings, UserModel, ViewMode } from "@/app/types"
...
export const userSlice = createSlice({
    ...
    reducers: {
        ...
        setNewsletterSettings: (state, action: PayloadAction<NewsletterSettings>) => {
            state.localSettings.newsletter = action.payload
        },
    },
...
export const { setViewMode, setSidebarWidth, setAnnouncementHash, setFontSizePercentage, setNewsletterSettings } = userSlice.actions
